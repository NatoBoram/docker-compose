...
| <img alt="Backrest logo"     src="../logos/backrest.png"     width="48px" /> | [Backrest](https://github.com/garethgeorge/backrest)               | Authentik, Geoblock | A web UI and orchestrator for restic backup                                                                          |
...
| <img alt="Element Logo"      src="../logos/element.png"      width="48px" /> | [Element](https://github.com/element-hq/element-web)               |                     | A glossy Matrix collaboration client for the web                                                                     |
| <img alt="Forgejo logo"      src="../logos/forgejo.png"      width="48px" /> | [Forgejo](https://codeberg.org/forgejo/forgejo)                    | Authentik, Geoblock | Beyond coding. We forge.                                                                                             |
...
| <img alt="Element Logo"      src="../logos/element.png"      width="48px" /> | [MAS](https://github.com/element-hq/matrix-authentication-service) |                     | A user management and authentication service for Matrix homeservers                                                  |
...
| <img alt="Ollama logo"       src="../logos/ollama.png"       width="48px" /> | [Ollama](https://github.com/ollama/ollama)                         | Authentik, Geoblock | Get up and running with large language models                                                                        |
| <img alt="Open WebUI logo"   src="../logos/open-webui.png"   width="48px" /> | [Open WebUI](https://github.com/open-webui/open-webui)             | Authentik, Geoblock | User-friendly AI Interface                                                                                           |
| <img alt="PeerTube logo"     src="../logos/peertube.png"     width="48px" /> | [PeerTube](https://github.com/Chocobozzz/PeerTube)                 | Anubis, Authentik   | ActivityPub-federated video streaming platform using P2P directly in your web browser                                |
...
| <img alt="Registry logo"     src="../logos/registry.png"     width="48px" /> | [Registry](https://github.com/distribution/distribution)           | Authentik, Geoblock | The toolkit to pack, ship, store, and deliver container content                                                      |
...
| <img alt="Element Logo"      src="../logos/element.png"      width="48px" /> | [Synapse](https://github.com/element-hq/synapse)                   | Authentik           | Matrix homeserver                                                                                                    |
...
| <img alt="Tandoor logo"      src="../logos/tandoor.png"      width="48px" /> | [Tandoor](https://github.com/TandoorRecipes/recipes)               | Authentik, Geoblock | Application for managing recipes, planning meals, building shopping lists and much much more!                        |
